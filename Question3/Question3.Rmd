...
title: "With No Love From Russia, Is The EU Stepping Up?"
...
rm(list=ls()) # starting by ensuring the environment is clean
# Initial setup 
...
# Source all functions contained in question 1's code file
...
album_name: Name of CD / album
explicit: Whether song contains explicit lyrics or not.
popularity: popularity score (out of 100)
acousticness: A confidence measure from 0.0 to 1.0 of whether the track is acoustic; acoustic means 'without electrical amplification' – an acoustic guitar versus an electric guitar, for example.
danceability: Describes how suitable a track is for dancing based on a combination of musical elements including tempo, rhythm stability, beat strength, and overall regularity.
energy: song energy is the sense of forward motion in music, whatever keeps the listener engaged and listening. In loud music, musical energy is easy to identify. We notice the energy more as the drums get busier and play louder, and as the singer sings higher.
instrumentalness:  Instrumentalness predicts whether a track contains vocals. Instrumentalness is measured on a scale of 0 (likely contains vocal content) to 100 (likely contains no vocal content). Songs with higher instrumentalness are less likely to have vocals
liveness: Detects the presence of an audience in the recording. Higher liveness values represent an increased probability that the track was performed live. A value above 0.8 provides strong likelihood that the track is live.
loudness: LUFS metering is the most accurate way of measuring perceived loudness because it resembles human hearing more closely than other meters. 
...
Total Financial Commitment vs. Allocation:
        Compare the total amount of financial commitments made by EU countries with the actual financial allocations (spending).
        Highlight discrepancies between promised aid and actual aid delivered.

Top Contributing Countries:
        Identify and list the top five EU countries based on both financial commitment and allocation.
        Highlight any significant differences between commitment and allocation within these top contributors.

Aid Over Time:
        Display how financial allocations have changed over time since the onset of the war.
        Show trends and highlight any periods of increased or decreased spending.

Per Capita Contributions:
        Analyze financial allocation and commitment per capita to show which countries are contributing the most relative to their population size.

Comparison with Non-EU Countries:
        If available, include a brief comparison of EU aid with significant non-EU contributors like the United States or Canada.-
Plot Ideas:

- Bar Charts:
        Top Contributors: Bar chart showing the top five countries by financial allocation and commitment.
        Per Capita Contributions: Bar chart displaying per capita financial allocation of different EU countries.

- Line Graphs:
        Aid Over Time: Line graph showing the trend of financial allocations over time, with key events marked.
        Commitment vs. Allocation Over Time: Line graph comparing the trends of financial commitments vs. actual allocations.

- Pie Charts:
        Allocation Distribution: Pie chart showing the distribution of financial allocations across different countries.
        Commitment Distribution: Pie chart showing the distribution of financial commitments across different countries.

- Heat Maps:
        Geographical Distribution: Heat map of Europe highlighting the intensity of financial allocation and commitment by country.

Stats to Highlight:

  -  Total Amounts:
        Total financial commitments and total allocations by the EU.
        Percentage of commitments that have been allocated.

   - Top Countries:
        Top three countries in terms of absolute financial allocation and commitment.
        Top three countries in terms of per capita allocation and commitment.

  -  Trends:
        Significant increases or decreases in aid over specific periods.
        Correlation between key events in the war and changes in financial allocation.

Summary for On-Air Interpretation:

   - Overview:
        Provide an overview of the EU's total financial commitment and allocation to Ukraine.
        Emphasize the gap between commitments and actual allocations.

   - Top Contributors:
        Highlight the top contributing countries and their relative generosity.
        Discuss any notable gaps between promised aid and delivered aid.

 -   Trends and Changes:
        Discuss how financial support has evolved over time and any significant fluctuations.
        Relate these trends to key events in the war for context.

  -  Per Capita Insights:
        Explain which countries are contributing the most on a per capita basis, showcasing a fairer measure of generosity relative to population size.

   - Conclusion:
        Summarize whether the EU's financial support has been sufficient based on the data.
        Offer insights into areas where EU support could improve or where it has been particularly strong.





### NOTE: population data not required here 
...
```{r Figure1,  warning =  FALSE, fig.align = 'center', fig.cap = "Caption Here \\label{Figure1}", fig.ext = 'png', fig.height = 3, fig.width = 6, dev = 'png', eval = F}
...
, 
```{r Figure2, warning =  FALSE, fig.align = 'center', fig.cap = "Caption Here \\label{Figure2}", fig.height = 3, fig.width = 6, dev = 'png', eval = F}
...
```{r ShortTable, results = 'asis', eval = F}
...
```{r LongTable, results = 'asis', eval = F}
