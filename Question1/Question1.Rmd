...
title: "Unveiling Trends in US Baby Names for Toy Character Inspiration"
...
### Loading in the data using Data_Prep function in code file: 

```{r, warning= FALSE}
Datroot <- "Data/US_Baby_names"
df <- Data_Prep(Datroot)
attach(df)
```


### Merging HBO_Credits and HBO_Titles 
...
```{r Figure1,  warning =  FALSE, fig.align = 'center', fig.cap = "Caption Here \\label{Figure1}", fig.ext = 'png', fig.height = 3, fig.width = 6,dev = 'png'}
